	...
	public static void main(String[] args) {		
	    ...
	    try {
	        ...
	        for(int i=0; i<movieList.size(); i++) {
	        	System.out.println((i+1) + ". " + movieList.get(i).getTitle() + " - " + movieList.get(i).getActors());
	        	bw.write((i+1) + ". " + movieList.get(i).getTitle() + " - " + movieList.get(i).getActors() + "\n");
	        }
